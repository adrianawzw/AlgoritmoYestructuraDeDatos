 ...
 * @author tapia
 */
public class vistaEjercicio3 extends javax.swing.JFrame {

    /**
     * Creates new form vistaEjercicio3
     */
    public vistaEjercicio3() {
        initComponents();
    }
    ...
    int num1=0, num2=0;
    private int convertir(String num){
    ...
    private void initComponents() {
        ...
        jButton5.setText("ultima operacion");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(txt_num1, javax.swing.GroupLayout.DEFAULT_SIZE, 90, Short.MAX_VALUE)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        num1 = convertir(txt_num1.getText());
        num2 = convertir(txt_num2.getText());
        
        int suma = num1+num2;
        String msj = num1+" + "+num2+" = "+suma;
        lista.agregarOperacion(msj);
        txt_res.setText(msj);
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        // TODO add your handling code here:
        String mos = lista.mostrarOperaciones();
        txt_res.setText(mos);
    }//GEN-LAST:event_jButton4ActionPerformed

    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        // TODO add your handling code here:
        String mos = lista.mostrarUltimo();
        txt_res.setText(mos);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(vistaEjercicio3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new vistaEjercicio3().setVisible(true);
            }
        });
    }
