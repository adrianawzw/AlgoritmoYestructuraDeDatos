...
public class ejercicio5 extends javax.swing.JFrame {
    ...
    Queue<Impresion> cola = new LinkedList<>();
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(txt_nom, javax.swing.GroupLayout.DEFAULT_SIZE, 114, Short.MAX_VALUE)
                            .addComponent(txt_id))
                        .addGap(69, 69, 69)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
            Impresion imp = new Impresion(id, nom);
            cola.add(imp);
            txt_id.setText("");
            txt_nom.setText("");
        }catch(IllegalStateException e){
            txt_res.setText("No se puedo agregar: "+e);
        }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        try{
            Impresion elim = cola.remove();
            txt_res.setText(elim.nom+" imprimiendo...");
        }catch(NoSuchElementException ex){
            txt_res.setText("Cola vacia: "+ex);
        }
